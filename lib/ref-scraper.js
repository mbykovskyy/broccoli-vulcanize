...
function RefScraper(excludes) {
  excludes = excludes || {};
  this.styleRefCollector = new StyleRefCollector(excludes.styles);
  this.scriptRefCollector = new ScriptRefCollector(excludes.scripts);
  this.importRefCollector = new ImportRefCollector(excludes.imports);
}
